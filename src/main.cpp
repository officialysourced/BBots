#include "main.h"
#include "autoncode.hpp" // Include your new header file

// Forward declaration for the combinedAutonRoutine function
...
void initialize() {
  ...
  ez::as::auton_selector.autons_add({
      {"Combined Auton", combinedAutonRoutine}, // <-- ADD THIS LINE
